...
<main class="container">
    ...
    <ul>
        <li>Sur la manière dont sont collectées leurs données personnelles — identifiant de connexion (login) et mot de passe chiffré</li>
    ...
    <a href="https://restaurationviteetgourmand.alwaysdata.net">restaurationviteetgourmand.alwaysdata.net</a> </p>


    <h3 class="text-center">ARTICLE 2 : PRINCIPES RELATIFS À LA COLLECTE ET AU TRAITEMENT DES DONNÉES PERSONNELLES </h3>
    ...
    <h3 class="text-center">ARTICLE 3 : DONNÉES À CARACTÈRE PERSONNEL COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE </h3>

    <h4 class="text-center">Article 3.1 : Données collectées </h4>

    <p>Les données personnelles collectées sont : identifiant de connexion (login)  , mot de passe hashé (bcrypt). Ces données sont collectées dans le but de permettre l'authentification et l'accès à l'interface . Le nom , prénom , adresse de livraison et de domicile ainsi que le numéro de mobile , sont collectés pour toute commande effectuée sur le site .</p>
    
    <h4 class="text-center">Article 3.2 : Mode de collecte des données </h4>

    <p>Les données sont collectées lors de l'inscription via le formulaire de création de compte ainsi qu'à la mise à jour du profile et à la prise de commande . Aucune donnée n'est collectée automatiquement lors de la simple visite du site. Les données sont conservées pour la durée d'activité du compte, puis supprimées sur demande.  Les données de compte sont supprimées dans un délai de 30 jours suivant la demande. Les données relatives aux commandes sont conservées 10 ans conformément aux obligations comptables en vigueur. </p>

    

    <h4 class="text-center">Article 3.3 : Hébergement des données </h4>

    <p>Le site est hébergé par Alwaysdata , 91 rue du faubourg St Honoré , 75008 Paris, France. </p>
    

    <h4 class="text-center">Article 3.4 : Politique en matière de “cookies”</h4>

    <p>Ce site utilise uniquement des cookies techniques strictement nécessaires à son fonctionnement (cookie de session pour l'authentification). Aucun cookie de tracking, publicitaire ou analytique n'est utilisé. Ces cookies ne nécessitent pas votre consentement conformément à la recommandation CNIL du 17 septembre 2020.</p>

    <h3 class="text-center">ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES ET DÉLÉGUÉ À LA PROTECTION DES DONNÉES</h3>

    <h4 class="text-center">Article 4.1 : Le responsable du traitement des données </h4>

    <p>Le responsable du traitement des données à caractère personnel peut être contacté de la manière suivante :   
    Vincent Didier Geraghty, Par mail :  contact@viteetgourmand.fr</p>
    
    <h4 class="text-center">Article 4.2 : Le délégué à la protection des données</h4>

    <p>Le délégué à la protection des données de l'entreprise ou du responsable est : </p>
    <p>Vincent  DIDIER GERAGHT , contact@viteetgourmand.fr</p>
    ...
    <h3 class="text-center">ARTICLE 5 : LES DROITS DE L'UTILISATEUR EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DES DONNÉES </h3>
    ...
    <p>Pour exercer vos droits, veuillez adresser votre  mail à  contact@viteetgourmand.fr</p>
    ...
    <h3 class="text-center">ARTICLE 6 : CONDITIONS DE MODIFICATION DE LA POLITIQUE DE CONFIDENTIALITÉ</h3>


    <p>L'éditeur du site « Vite & Gourmand » se réserve le droit de pouvoir modifier la présente Politique à tout moment afin d'assurer aux utilisateurs du site sa conformité avec le droit en vigueur.   </p>
    ...
    <p>La présente politique, éditée le 05/04/2026, a été mise à jour le 05/04/2026 .</p>
</main>
<?php
